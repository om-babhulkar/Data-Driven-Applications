...
LOG_FILE_TRAIN_MODEL = LOG_DIR / "train.log"
...
helper_logger=get_logger("helper",HELPER_FILE_EVALUATE)
app_logger=get_logger("app",APP_FILE)
main_logger=get_logger("main",MAIN_FILE)
